...
$txt = "";
  foreach ($_POST as $key => $value) {
   ...
   $txt = $txt . PHP_EOL . htmlspecialchars($key).": ".htmlspecialchars($value) . "(kg)" . PHP_EOL;
      }
  }
  $select1 = $_POST['sklep'];
  $path = "";
      ...
      <div class="row">
        ...
        <?php
          ...
          foreach($bazawo as $item)
          {
             ...
             echo '<input type="number" step="0.001" class="hbulki" id="hbulki" name="'.$item.'" placeholder="0 (kg)" autofocus="true"/>';
          }
          ?>
